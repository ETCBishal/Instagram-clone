      ...
      <div className="w-screen h-screen flex items-center justify-center">
        <div className="flex flex-col gap-5">
          <form
            ...
            className="max-w-[90vw] sm:max-w-[50vw] md:max-w-[25vw] min-h-[40vh] h-[60vh] flex justify-center outline outline-gray-400"
          >
            {/* wrapper */}
            <div className="w-[90%] flex flex-col items-center justify-center gap-5">
              ...
              <div className="flex flex-col items-center justify-center gap-5">
                ...
                <div className="flex flex-col items-center justify-center text-gray-500 text-[13px] sm:text-[14px] md:text-[15px]">
                  <span>Singup to see photoes and videos</span>
          ...
          <NavLink
            to={"/login"}
            className="w-[90vw] sm:w-[50vw] md:w-[25vw] h-[50px] sm:h-[70px] flex flex-col items-center justify-center outline outline-gray-400 text-[13px]"
          >
            <p>Have an account?</p>
